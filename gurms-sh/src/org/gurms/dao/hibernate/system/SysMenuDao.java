...
public class SysMenuDao extends HibernateDao<SysMenu>{
	...
	public static final String QUERY_MENUS_BY_USERID = "select distinct m from SysMenu m,SysRole r,SysUser u where m in elements(r.sysmenus) and r in elements(u.sysroles) and r.rolestatus='1' and u.userid=? ";
